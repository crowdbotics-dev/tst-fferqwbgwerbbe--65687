...
## Project Structure
    ...
    ├── tst_fferqwbgwerbbe__65687  # Django project configurations
...
1. Clone this repo and `cd tst_fferqwbgwerbbe__65687`
...
2. Clone this repo and `cd tst_fferqwbgwerbbe__65687`
